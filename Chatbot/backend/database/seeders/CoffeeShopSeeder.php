...
class CoffeeShopSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // CATEGORIES
        // =====================
        $categories = ['Hot Coffee', 'Iced Coffee', 'Non-Coffee', 'Tea', 'Frappe & Blended', 'Snacks', 'Pastry'];
        ...
        foreach ($ingredients as $data) {
            $ingredientModels[$data['name']] = Ingredient::firstOrCreate(['name' => $data['name']], $data);
        }
        ...
        foreach ($products as $data) {
            $data['image_url'] = '/example-photo.jpg'; // Dummy image as requested
            $productModels[$data['name']] = Product::firstOrCreate(['name' => $data['name']], $data);
        }
        ...
        // =====================
        $variantsMap = [
            'Cappuccino' => [['variant_name' => 'Regular', 'additional_price' => 0], ['variant_name' => 'Large', 'additional_price' => 5000]],
            'Latte' => [['variant_name' => 'Regular', 'additional_price' => 0], ['variant_name' => 'Large', 'additional_price' => 5000]],
            'Iced Latte' => [['variant_name' => 'Regular', 'additional_price' => 0], ['variant_name' => 'Large', 'additional_price' => 5000]],
            'Es Kopi Susu' => [['variant_name' => 'Regular', 'additional_price' => 0], ['variant_name' => 'Large', 'additional_price' => 5000]],
        ];
        ...
        foreach ($variantsMap as $productName => $variants) {
            ...
            foreach ($variants as $v) {
                ProductVariant::firstOrCreate(
                    ['product_id' => $productModels[$productName]->id, 'variant_name' => $v['variant_name']],
                    $v
                );
            }
        }
        ...
        $addonsMap = [
            'Espresso' => [['addon_name' => 'Extra Shot', 'price' => 5000]],
            'Cappuccino' => [['addon_name' => 'Extra Shot', 'price' => 5000], ['addon_name' => 'Oat Milk', 'price' => 8000]],
            'Latte' => [['addon_name' => 'Extra Shot', 'price' => 5000], ['addon_name' => 'Oat Milk', 'price' => 8000], ['addon_name' => 'Almond Milk', 'price' => 10000]],
            'Iced Latte' => [['addon_name' => 'Extra Shot', 'price' => 5000], ['addon_name' => 'Oat Milk', 'price' => 8000]],
            'Cheese Fries' => [['addon_name' => 'Extra Cheese', 'price' => 5000]],
        ];

        foreach ($addonsMap as $productName => $addons) {
            if (!isset($productModels[$productName])) continue;
            foreach ($addons as $a) {
                ProductAddon::firstOrCreate(
                    ['product_id' => $productModels[$productName]->id, 'addon_name' => $a['addon_name']],
                    $a
                );
            }
        }
        ...
        // =====================
        $recipes = [
            'Espresso' => [['ingredient' => 'Espresso Shot', 'quantity' => 30]],
            'Americano' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Water', 'quantity' => 120]],
            'Cappuccino' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 120]],
            'Latte' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 180]],
            'Mocha' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 150], ['ingredient' => 'Chocolate Sauce', 'quantity' => 30]],
            'Vanilla Latte' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Vanilla Syrup', 'quantity' => 20]],
            'Caramel Macchiato' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Vanilla Syrup', 'quantity' => 15], ['ingredient' => 'Caramel Syrup', 'quantity' => 15]],
            'Hazelnut Latte' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Hazelnut Syrup', 'quantity' => 20]],
            'Iced Americano' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Water', 'quantity' => 100], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Iced Latte' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Iced Mocha' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 150], ['ingredient' => 'Chocolate Sauce', 'quantity' => 30], ['ingredient' => 'Ice Cubes', 'quantity' => 150], ['ingredient' => 'Whipped Cream', 'quantity' => 30]],
            'Vietnamese Coffee' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Condensed Milk', 'quantity' => 40], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Es Kopi Susu' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 100], ['ingredient' => 'Brown Sugar Syrup', 'quantity' => 25], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Brown Sugar Latte' => [['ingredient' => 'Espresso Shot', 'quantity' => 60], ['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Brown Sugar Syrup', 'quantity' => 30], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Hot Chocolate' => [['ingredient' => 'Fresh Milk', 'quantity' => 200], ['ingredient' => 'Chocolate Sauce', 'quantity' => 40]],
            'Iced Chocolate' => [['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Chocolate Sauce', 'quantity' => 40], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Matcha Latte' => [['ingredient' => 'Matcha Powder', 'quantity' => 5], ['ingredient' => 'Fresh Milk', 'quantity' => 200], ['ingredient' => 'Simple Syrup', 'quantity' => 15]],
            'Iced Matcha Latte' => [['ingredient' => 'Matcha Powder', 'quantity' => 5], ['ingredient' => 'Fresh Milk', 'quantity' => 180], ['ingredient' => 'Simple Syrup', 'quantity' => 15], ['ingredient' => 'Ice Cubes', 'quantity' => 150]],
            'Hot Green Tea' => [['ingredient' => 'Green Tea Leaves', 'quantity' => 3], ['ingredient' => 'Water', 'quantity' => 250]],
            'Jasmine Tea' => [['ingredient' => 'Jasmine Tea', 'quantity' => 3], ['ingredient' => 'Water', 'quantity' => 250]],
            'French Fries' => [['ingredient' => 'French Fries', 'quantity' => 150]],
            'Cheese Fries' => [['ingredient' => 'French Fries', 'quantity' => 150], ['ingredient' => 'Cheese', 'quantity' => 50]],
            'Butter Croissant' => [['ingredient' => 'Croissant', 'quantity' => 1], ['ingredient' => 'Butter', 'quantity' => 15]],
            'Chocolate Croissant' => [['ingredient' => 'Croissant', 'quantity' => 1], ['ingredient' => 'Chocolate Sauce', 'quantity' => 20]],
            'Ham & Cheese Croissant' => [['ingredient' => 'Croissant', 'quantity' => 1], ['ingredient' => 'Ham', 'quantity' => 30], ['ingredient' => 'Cheese', 'quantity' => 25]],
        ];

        foreach ($recipes as $productName => $details) {
            if (!isset($productModels[$productName])) continue;
            $recipe = Recipe::firstOrCreate(['product_id' => $productModels[$productName]->id]);
            foreach ($details as $detail) {
                if (!isset($ingredientModels[$detail['ingredient']])) continue;
                RecipeDetail::firstOrCreate(
                    ['recipe_id' => $recipe->id, 'ingredient_id' => $ingredientModels[$detail['ingredient']]->id],
                    ['quantity' => $detail['quantity']]
                );
            }
        }

        $this->command->info('☕ Coffee Shop data seeded!');
    }
}
